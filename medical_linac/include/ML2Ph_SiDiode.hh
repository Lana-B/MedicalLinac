...
#ifndef CML2Ph_SiDiodeH
#define CML2Ph_SiDiodeH
...
private:
    ...
    G4VPhysicalVolume *SiDiodeSidesPV;
    ...
    G4double phantomRadiusInner;
    G4double phantomRadiusOuter;
    G4double phantomHeight;
